...
@description('Determines whether to deploy a Function App and associated resources.')
...
@description('Creates an Azure Function App and associated resources.')
module functionApp 'function-app.bicep' = if (deployFunctionApp) {
  name: 'functionApp'
  params: {
    functionAppServicePlanName: '${abbrs.webServerFarms}${resourceToken}'
